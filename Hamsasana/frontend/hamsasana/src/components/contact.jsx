...
function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_c3o0cf1', 'template_hekaw5c', form.current, {
        publicKey: 'nHTLF_tusAg3_2TQr',
      })
      .then(
        () => {
          console.log('SUCCESS!');
        ...
        <h1 className='font-bold  text-left px-8 text-3xl mt-6 '>Contact Us</h1>
            ...
            <div className=' bg-slate-100 dark:bg-slate-900 dark:text-white   md:flex-row  w-full  md:w-1/2 md:mt-10 mt-12  justify-center grid grid-flow-col'>
              ...
              <Lottie  loop={true} autoplay={true} animationData={contact} />
                ...
                <div className='w-full md:w-1/2 grid grid-flow-row justify-center  mt-5 space-y-2 bg-slate-100 dark:bg-slate-900 dark:text-white '>
                    ...
                    <input type="text" className="grow" placeholder="Username" name='from_name' />
                    </label>
                    ...
                    <button type='submit' className="btn btn-xs border-none bg-orange-500 text-white hover:bg-orange-700 cursor-pointer hover:-translate-y-1 hover:scale-110 duration:300s sm:btn-sm md:btn-md lg:btn-lg" ref={form} onSubmit={sendEmail}>Submit</button>
