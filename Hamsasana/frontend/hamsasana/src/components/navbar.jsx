...
function Navbar() {
    ...
    <div className={`navbar max-w-screen-2xl container mx-auto md:px-20 px-4 right-0 left-0 sticky ${
        sticky?"sticky-navbar shadow-md base-bg-200 duration 300 transition-all ease-in-out":""
        }`}>
        <div className="navbar-start ">
            ...
            <a className="btn btn-ghost text-2xl font-bold cursor-pointer ">Hamsasana</a>
        </div>
        <div className="navbar-end  ">
        <div className="navbar-center hidden lg:flex ">
            <ul className="menu menu-horizontal px-1 py-4 text-l ">
                {navItems}
            </ul>
        ...
        <a className="bg-black text-white p-2 rounded-md mx-4 cursor-pointer hover:-translate-y-1 hover:scale-110 duration:300s">
            login
        </a>
        </div>
        </div>
