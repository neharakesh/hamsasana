        ...
        <div className="navbar-center hidden lg:flex dark:bg-slate-600 dark:text-white ">
            ...
            <div className='w-auto py-5 dark:bg-slate-600 '>
                <label className="swap swap-rotate ">
                    ...
                    {/* sun icon */}
                    <svg className="swap-off fill-current w-10 h-8 dark:bg-slate-600 dark:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24 " 
