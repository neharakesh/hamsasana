...
function Banner() {
    ...
    return (
        <>
            ...
            <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row bg-white mt-10 mb-10 dark:bg-slate-900 dark:text-white'>
                <div className='w-full md:w-1/2 md:mt-32 mt-12 justify-center grid grid-flow-col'>
                    ...
                    <div className='px-32 '>
                        <img className='w-25' data-aos="zoom-in" src={tech} alt="" />
                    </div>
